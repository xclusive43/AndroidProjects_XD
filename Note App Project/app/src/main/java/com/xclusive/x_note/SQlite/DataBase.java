...
public class DataBase extends SQLiteOpenHelper {
    ...
    public Integer insertdata(String ID,String TITLE,String SUBTITILE,String DEC,String DATE,String DATA,String COLOR,int token){
        Long res1 = null;
...
//        }
    ...
    public Integer update(String id,String TITLE,String SUBTITILE,String DEC,String DATE,String DATA,String COLOR){
        ...
        contentValues.put(COL5,DATA);
        contentValues.put(COL6,COLOR);
        int res =   db.update(TABLENAME,contentValues,"ID = ?",new String[]{id});
